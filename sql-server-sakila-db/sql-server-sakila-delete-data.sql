...
-- Delete data
ALTER TABLE staff DROP CONSTRAINT if exists fk_staff_address;
...
ALTER TABLE store DROP CONSTRAINT if exists fk_store_staff;
DROP INDEX if exists idx_fk_address_id ON store;
